...
If you want to run Rangoli locally or contribute to the source code:

1. **Clone the repository**
   ```bash
   git clone https://github.com/sivadasrajan/rangoli.git
   cd rangoli
   ```
...
Rangoli is open source and community-driven! Whether you want to fix a bug, add a new feature, or improve the documentation, your contributions are incredibly welcome. 

Feel free to open an issue or submit a Pull Request. Let's make event management stress-free together!
...
---
*Developed by [@sivadasrajan](https://github.com/sivadasrajan) and Agentic AI.*
